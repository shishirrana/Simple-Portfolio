...
namespace com.portfolio.website.Controllers
{
    public class LanguagesController : Controller
    {
        ...
        public LanguagesController(comportfoliowebsiteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Language != null ? 
                          ...
                          Problem("Entity set 'comportfoliowebsiteContext.Language'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,LName")] Language language)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'comportfoliowebsiteContext.Language'  is null.");
            }
            var language = await _context.Language.FindAsync(id);
            if (language != null)
            {
