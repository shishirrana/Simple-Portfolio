...
namespace com.portfolio.website.Controllers
{
    public class SkillsController : Controller
    {
        ...
        public SkillsController(comportfoliowebsiteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Skill != null ? 
                          ...
                          Problem("Entity set 'comportfoliowebsiteContext.Skill'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Rating")] Skill skill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Rating")] Skill skill)
        {
            if (id != skill.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'comportfoliowebsiteContext.Skill'  is null.");
            }
            var skill = await _context.Skill.FindAsync(id);
            if (skill != null)
            {
